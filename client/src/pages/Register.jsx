...
const Register = () => {
  ...
  return (
    <div className='auth'>
      <h1>Register</h1>
      <form>
        <input required type="text" placeholder='Yonetici Adi' onChange={(event) => {setYoneticiAdi(event.target.value)}} />
        ...
        <p> Bu bir hatadir!</p>
        <span>Hesabiniz var mi? < Link to="/login"> Giris Yap </ Link>  </span>
      </form>
    </div>
  )
}
